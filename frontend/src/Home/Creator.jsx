              ...
              <div key={element._id}>
                <div className="">
                  <img
                    ...
                    alt="blog"
                    className="md:w-56 md:h-56 object-cover  border-black border-2 rounded-full items-center "
                  />
                  <div className="text-center md:ml-[-150]">
                    <p>{element.name}</p>
                    <p className="text-red-500 text-xs">{element.role}</p>
                  </div>
                </div>
              </div>
            );
